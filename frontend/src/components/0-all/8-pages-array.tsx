...
import { Page_Registry } from "../2-main/3-tab-registry/0-editor/0-all-editor";
import { Page_ToolsMenuEditor } from "../2-main/4-tab-tools-menu-editor/0-editor/0-all-editor";
...
// App title format: traytools: Welcome (🦈 elevated)

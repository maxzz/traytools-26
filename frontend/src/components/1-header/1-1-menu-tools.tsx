 ...
 * We (re)load the tree whenever the menu is opened so edits to the config file are picked up without restarting the app.
 * `active` is driven by the parent Menubar's open value.
 */

    ...
    return (
        <div className={classNames("text-xs font-condensed flex flex-col", className)} {...rest}>
            ...
            <div className="flex-1 min-h-0">
                <ResizablePanelGroup orientation="horizontal" defaultLayout={horizontalLayout as Layout} onLayoutChanged={(layout) => savePanelLayout(PANEL_GROUPS.demosHorizontal, layout)}>
                    ...
                    <ResizablePanel id="right" minSize={20}>
                        <ResizablePanelGroup orientation="vertical" defaultLayout={verticalLayout as Layout} onLayoutChanged={(layout) => savePanelLayout(PANEL_GROUPS.demosVertical, layout)}>

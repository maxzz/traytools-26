import { DialogContent, DialogHeader, DialogClose } from "@/ui/shadcn/dialog";
    ...
    return (
        ...
        >
            <DialogHeader className="relative pl-4 pr-2 py-1 text-sm font-bold border-border border-b flex flex-row items-center justify-between space-y-0">
                ...
                <DialogClose className="relative! right-0! top-0! p-2 hover:text-white hover:bg-red-500 hover:opacity-100 focus:ring-0 active:scale-[.97]" tabIndex={-1} onClick={() => onDlgClose(false)} />
            </DialogHeader>

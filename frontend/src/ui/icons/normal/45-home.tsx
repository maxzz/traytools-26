import { type HTMLAttributes } from "react"; // https://heroicons.com/outline/home
import { classNames } from "@/utils";

export function IconHome({ className, title, ...rest }: HTMLAttributes<SVGSVGElement>) {
    return (
...
export function IconHomeModern({ className, title, ...rest }: HTMLAttributes<SVGSVGElement>) {
    return (
        <svg className={classNames("fill-none stroke-current stroke-[1.5px]", className)} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" {...rest}>
            {title && <title>{title}</title>}

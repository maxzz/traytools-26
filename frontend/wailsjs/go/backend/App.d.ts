...
export function CancelQuitPrompt():Promise<void>;
...
export function SetWindowSizeKeyOption(arg1:context.Context,arg2:string):Promise<string>;
...
export function ToggleWindowSizeOption(arg1:context.Context):Promise<string>;
